 ...
 *
 * 👉 POUR REMPLIR / MODIFIER :
 *   - Clé = `id` de la formation (voir src/data/programs.ts), ex. "campus-marketing".
 *   - Marketing digital = contenu réel. Les autres formations Campus = modèles à valider.
 *   - 1re année (Licence 1) commune à toutes les formations Campus (tronc commun).
 */
...
// ── Tronc commun Licence 1 (toutes formations Campus) ──────
...
/** Construit un programme Campus standard (L1 commune + spécialisation). */
function buildCampusProgram(
  l1Objective: string,
...
export const programDetails: Record<string, ProgramDetail> = {
  ...
  "campus-communication": buildCampusProgram(
  ...
  "campus-design": buildCampusProgram(
  ...
  "campus-ecommerce": buildCampusProgram(
  ...
  "campus-management": buildCampusProgram(
  ...
  "campus-finance": buildCampusProgram(
