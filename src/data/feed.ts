...
const NEWS: Feed = {
  ...
  items: [
    { id: "n1", title: "L'IA générative transforme les métiers du digital", category: "Intelligence artificielle", date: "Juin 2026", readingTime: "3 min", summary: "Tour d'horizon des usages qui transforment le travail et les compétences attendues.", icon: "🤖", tags: ["Intelligence artificielle"], featured: true },
    { id: "n2", title: "Les métiers les plus demandés dans le digital et l'IA", category: "Digital & métiers", date: "Juin 2026", readingTime: "4 min", summary: "Quels profils recrutent le plus en 2026 et comment s'y préparer concrètement.", icon: "📊", tags: ["Digital & métiers", "Conseils carrière"], featured: true },
...
const JOBS: Feed = {
  ...
  items: [
    { id: "j1", title: "Community Manager", subtitle: "Agence digitale", category: "Alternance", date: "Publié en juin 2026", deadline: "Clôture 15 juil. 2026", meta: ["Alternance", "Abidjan", "Présentiel", "Marketing digital", "Niveau : Bac+2"], summary: "Animer les réseaux sociaux et créer du contenu engageant.", icon: "📣", tags: ["Alternance", "Présentiel", "Abidjan", "Marketing digital"] },
    { id: "j2", title: "Designer graphique", subtitle: "Studio créatif", category: "Freelance", date: "Publié en juin 2026", meta: ["Freelance", "À distance", "Design", "Niveau : Confirmé"], summary: "Créer des identités visuelles fortes pour des marques variées.", icon: "🎨", tags: ["Freelance", "À distance", "Design"] },
    { id: "j3", title: "Développeur web junior", subtitle: "TechCorp", category: "Emploi", date: "Publié en juin 2026", deadline: "Clôture 30 juil. 2026", meta: ["CDI", "Abidjan", "Hybride", "Développement", "Niveau : Débutant accepté"], summary: "Rejoindre une équipe produit et développer des applications modernes.", icon: "💻", tags: ["Emploi", "Hybride", "Abidjan", "Développement"] },
    { id: "j4", title: "Data Analyst junior", subtitle: "Groupe bancaire", category: "Stage", date: "Publié en mai 2026", deadline: "Clôture 20 juil. 2026", meta: ["Stage", "Abidjan", "Présentiel", "Data", "Niveau : Bac+3"], summary: "Analyser les données pour appuyer la prise de décision.", icon: "📊", tags: ["Stage", "Présentiel", "Abidjan", "Data"] },
    { id: "j5", title: "Assistant marketing digital", subtitle: "PME en croissance", category: "Stage", date: "Publié en mai 2026", meta: ["Stage", "Abidjan", "Hybride", "Marketing digital", "Niveau : Débutant accepté"], summary: "Appuyer les campagnes, le contenu et le suivi des performances.", icon: "📈", tags: ["Stage", "Hybride", "Abidjan", "Marketing digital"] },
    { id: "j6", title: "Support client digital", subtitle: "Centre de services", category: "Emploi", date: "Publié en mai 2026", meta: ["CDI", "Abidjan", "Présentiel", "Support client", "Niveau : Débutant accepté"], summary: "Offrir un service client réactif et professionnel en ligne.", icon: "💬", tags: ["Emploi", "Présentiel", "Abidjan", "Support client"] },
    { id: "j7", title: "Traffic Manager junior", subtitle: "Agence média", category: "Emploi", date: "Publié en avril 2026", meta: ["CDI", "Abidjan", "Hybride", "Marketing digital", "Niveau : Bac+3"], summary: "Piloter des campagnes Meta & Google rentables.", icon: "🎯", tags: ["Emploi", "Hybride", "Abidjan", "Marketing digital"] },
    { id: "j8", title: "Assistant IA métier", subtitle: "Startup IA", category: "Alternance", date: "Publié en avril 2026", meta: ["Alternance", "À distance", "IA", "Niveau : Bac+2"], summary: "Automatiser des tâches et accélérer la production avec l'IA.", icon: "🤖", tags: ["Alternance", "À distance", "IA"] },
    { id: "j9", title: "UI Designer junior", subtitle: "Studio produit", category: "Emploi", date: "Publié en avril 2026", meta: ["CDI", "Abidjan", "Hybride", "Design", "Niveau : Débutant accepté"], summary: "Concevoir des interfaces fluides et désirables.", icon: "🖌️", tags: ["Emploi", "Hybride", "Abidjan", "Design"] },
    { id: "j10", title: "Assistant e-commerce", subtitle: "Boutique en ligne", category: "Freelance", date: "Publié en mars 2026", meta: ["Freelance", "À distance", "Marketing digital", "Niveau : Débutant accepté"], summary: "Gérer une boutique en ligne et booster les ventes.", icon: "🛒", tags: ["Freelance", "À distance", "Marketing digital"] },
  ],
};
...
const OPPORTUNITIES: Feed = {
  ...
  actions: [
    ...
    { label: "Recevoir les alertes", href: "/contact" },
  ],
  items: [
    ...
    { id: "o6", title: "Programmes internationaux & mobilité", category: "Programmes internationaux", status: "Candidatures ouvertes", meta: ["International", "Tous"], summary: "Mobilité, partenariats et opportunités à l'international.", icon: "✈️", tags: ["Programmes internationaux"] },
