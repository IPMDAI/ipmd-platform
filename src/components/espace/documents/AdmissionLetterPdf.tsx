...
const s = StyleSheet.create({
  ...
  para: { marginTop: 8 },
  tableTitle: { marginTop: 12, fontSize: 9, fontWeight: 700, color: BLACK, textTransform: "uppercase", letterSpacing: 0.5 },
  ...
  tdKey: { width: "55%", padding: 5, color: MUTED },
  tdVal: { width: "45%", padding: 5, color: BLACK, fontWeight: 700, textAlign: "right" },
  disclaimer: {
    marginTop: 8,
  ...
  sigRow: { marginTop: 18, flexDirection: "row", justifyContent: "space-between", alignItems: "flex-end" },
