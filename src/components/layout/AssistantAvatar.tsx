...
/**
 * Avatar de l'assistante d'admission IPMD.
 * Utilise la photo /awa.png si elle existe ; sinon, illustration SVG de secours.
 * Pour changer la photo : déposez votre image dans public/awa.png (carré conseillé).
 */
export function AssistantAvatar({ className = "h-9 w-9" }: { className?: string }) {
  ...
  return <AvatarIllustration className={className} />;
}

/** Illustration de secours (femme souriante + casque rouge IPMD). */
