...
export const metadata: Metadata = {
  title: "Admission — formulaire classique",
  description:
    "Déposez votre demande d'inscription à IPMD. Processus simple en quelques étapes.",
  // Formulaire historique conservé temporairement pendant la bascule vers le
  // wizard : non indexé pour éviter tout contenu dupliqué avec /admission.
...
export default async function AdmissionLegacyPage() {
